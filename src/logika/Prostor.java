...
public class Prostor {
     ...
     * @param posLeft pozice obrázku v pixelech na mapě z levé strany
     * @param posTop pozice obrázku v pixelech na mapě z horní strany
     */
    ...
    private String popisVeci() {
        ...
        if(i==0){
            vracenyText="Nejsou zde žádné předměty";
        }
        return vracenyText;
    }
    ...
    private String popisPostav(){
        ...
        if(i==0){
            vracenyText="Nejsou zde žádné postavy.";
        }
        return vracenyText;
    }
    /**
